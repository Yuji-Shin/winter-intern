...
def handle_intent(intent: str, rtde_c, rtde_r, state):
    ...
    if intent == "PAIN":
        ...
        ok, moved = moveL_delta(rtde_c, rtde_r, 0.0, 0.0, +PAIN_RETRACT_Z_M, retract_speed, retract_acc)
        print("retract ok:", ok)
        state["armed"] = False
    ...
    if intent == "SEQUENCE":
        print("[INTENT] SEQUENCE (placeholder)")
        return {"ok": True, "moved": 0.0}
